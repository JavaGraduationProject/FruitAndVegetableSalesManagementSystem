<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出产地" prop="chuchandi">
          <el-input v-model="ruleForm.chuchandi" 
              placeholder="出产地" clearable  :readonly="ro.chuchandi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出产地" prop="chuchandi">
              <el-input v-model="ruleForm.chuchandi" 
                placeholder="出产地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详情描述" prop="xiangqingmiaoshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangqingmiaoshu" label="详情描述" prop="xiangqingmiaoshu">
                    <span v-html="ruleForm.xiangqingmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqingmiaoshu = this.ruleForm.xiangqingmiaoshu.replace(reg,'../../../ssmilxbd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
